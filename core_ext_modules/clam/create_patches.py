...
@hydra.main(
    version_base="1.2.0", config_path="config", config_name=os.path.join('patch_extraction', 'default')
)
def main(cfg: DictConfig):
	...
	if cfg.process_list:
		process_list = os.path.join(cfg.save_dir, cfg.process_list)
	else:
		process_list = None
	...
	seg_times, patch_times = seg_and_patch(**directories, **parameters,
											...
											seg = cfg.seg,  use_default_params=False, save_mask = True, 
											stitch= cfg.stitch, custom_downsample = cfg.custom_downsample, 
											patch_level=cfg.patch_level, patch = cfg.patch,
											process_list = process_list, auto_skip=cfg.no_auto_skip)
